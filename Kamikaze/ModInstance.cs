...
namespace ElectricRoads
{
    ...
    {
        public override string SimpleName { get; } = "Loading Screen Mod Airports temporary fix - ending";
        ...
        {
            [2858591409L] = "Loading Screen Mod Revisited"
        };
...
namespace Kwytto
{
    public static class CommonProperties
    {
        ...
        public static string Acronym { get; } = "LSM";
        ...
        public static Color ModColor { get; } = ColorExtensions.FromRGB("017158");
